...
{
  let stringArr =['KIM HYE IN','Front-end Developers','JavaScript','css','React']
  let selectStrting = stringArr[Math.floor(Math.random()*stringArr.length)]
  let selectStrtingArr = selectStrting.split("");

  return(selectStrtingArr)
}
